 ...
 * ── 示例 ──
 *   # 先运行生成器
 *   java -jar target/abyss-record-generator-1.0-SNAPSHOT-jar-with-dependencies.jar --stats "src/test/java/org/example/v59_6.6深渊使用率统计（第一期） - 副本.json" --out target/test_output --users 300 --seed 42
 *
 *   # 再验证
